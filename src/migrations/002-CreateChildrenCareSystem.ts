  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE placements (
        ...
        placement_number VARCHAR UNIQUE NOT NULL,
    ...
    await queryRunner.query(`
      CREATE TABLE safeguarding_incidents (
        ...
        police_reference VARCHAR(255),
        reported_to_lado BOOLEAN DEFAULT FALSE,
        lado_reference VARCHAR(255),
        reported_to_ofsted BOOLEAN DEFAULT FALSE,
        ofsted_reference VARCHAR(255),
    ...
    await queryRunner.query(`
      CREATE TABLE personal_education_plans (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        pep_number VARCHAR UNIQUE NOT NULL,
        child_id UUID NOT NULL REFERENCES children(id) ON DELETE RESTRICT,
        organization_id UUID NOT NULL REFERENCES organizations(id) ON DELETE RESTRICT,
    ...
    await queryRunner.query(`
      CREATE TABLE health_assessments (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        assessment_number VARCHAR UNIQUE NOT NULL,
        child_id UUID NOT NULL REFERENCES children(id) ON DELETE RESTRICT,
        organization_id UUID NOT NULL REFERENCES organizations(id) ON DELETE RESTRICT,
        assessment_type VARCHAR(100) NOT NULL,
        assessment_date DATE NOT NULL,
        next_assessment_due DATE,
        health_professional VARCHAR(255),
    ...
    await queryRunner.query(`
      CREATE TABLE family_members (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        family_member_number VARCHAR UNIQUE NOT NULL,
        child_id UUID NOT NULL REFERENCES children(id) ON DELETE RESTRICT,
        organization_id UUID NOT NULL REFERENCES organizations(id) ON DELETE RESTRICT,
    ...
    await queryRunner.query(`
      CREATE TABLE contact_schedules (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        schedule_number VARCHAR UNIQUE NOT NULL,
        child_id UUID NOT NULL REFERENCES children(id) ON DELETE RESTRICT,
    ...
    await queryRunner.query(`
      CREATE TABLE care_plans (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        plan_number VARCHAR UNIQUE NOT NULL,
        child_id UUID NOT NULL REFERENCES children(id) ON DELETE RESTRICT,
        organization_id UUID NOT NULL REFERENCES organizations(id) ON DELETE RESTRICT,
    ...
    await queryRunner.query(`
      CREATE TABLE care_plan_reviews (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        review_number VARCHAR UNIQUE NOT NULL,
        ...
        review_status VARCHAR(50) DEFAULT 'SCHEDULED',
    ...
    await queryRunner.query(`
      CREATE TABLE pathway_plans (
        ...
        organization_id UUID NOT NULL REFERENCES organizations(id) ON DELETE RESTRICT,
        plan_status VARCHAR(50) DEFAULT 'DRAFT',
        leaving_care_status VARCHAR(50) NOT NULL,
        start_date DATE NOT NULL,
        last_review_date DATE,
        next_review_date DATE,
        personal_advisor_name VARCHAR(255),
        accommodation_type VARCHAR(100),
        eet_status VARCHAR(100),
    ...
    await queryRunner.query(`
      CREATE TABLE uasc_profiles (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        uasc_number VARCHAR UNIQUE NOT NULL,
        child_id UUID NOT NULL REFERENCES children(id) ON DELETE RESTRICT,
        organization_id UUID NOT NULL REFERENCES organizations(id) ON DELETE RESTRICT,
        status VARCHAR(50) DEFAULT 'ACTIVE',
        arrival_date DATE NOT NULL,
        arrival_location VARCHAR(255),
        arrival_route VARCHAR(50),
        ...
        home_office_reference VARCHAR(255),
        asylum_claim_date DATE,
        age_disputed BOOLEAN DEFAULT FALSE,
        trafficking_risk VARCHAR(50) DEFAULT 'LOW',
    ...
    await queryRunner.query(`
      CREATE TABLE immigration_statuses (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        status_number VARCHAR UNIQUE NOT NULL,
        uasc_profile_id UUID NOT NULL REFERENCES uasc_profiles(id) ON DELETE CASCADE,
        status_date DATE NOT NULL,
        status_type VARCHAR(100) NOT NULL,
        is_current BOOLEAN DEFAULT TRUE,
        asylum_claim_status VARCHAR(100) DEFAULT 'NOT_YET_SUBMITTED',
        leave_to_remain_type VARCHAR(100),
        leave_granted_date DATE,
        leave_expiry_date DATE,
        brp_number VARCHAR(255),
        brp_expiry_date DATE,
        appeal_status VARCHAR(50) DEFAULT 'NOT_APPEALED',
    ...
    await queryRunner.query(`
      CREATE TABLE home_office_correspondence (
        id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
        correspondence_number VARCHAR UNIQUE NOT NULL,
        uasc_profile_id UUID NOT NULL REFERENCES uasc_profiles(id) ON DELETE CASCADE,
