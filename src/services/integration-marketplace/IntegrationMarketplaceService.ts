...
export class IntegrationMarketplaceService {
  ...
  async getAvailableIntegrations(organizationId: string): Promise<AvailableIntegration[]> {
    try {
      ...
      console.error(`Failed to get available integrations: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
  ...
  async getIntegrationsByCategory(category: string): Promise<AvailableIntegration[]> {
    try {
      ...
      console.error(`Failed to get integrations by category: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  async getRecommendedIntegrations(organizationId: string): Promise<AvailableIntegration[]> {
    try {
      ...
      console.error(`Failed to get recommended integrations: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  async installIntegration(
    ...
    try {
      ...
      console.error(`Failed to install integration: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      ...
      await this.logIntegrationEvent({
        ...
        action: 'INSTALL',
        status: 'ERROR',
        metadata: { userId, error: error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error" },
      });
  ...
  async configureIntegration(
    ...
    try {
      ...
      console.error(`Failed to configure integration: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  async testIntegration(organizationId: string, integrationId: string): Promise<any> {
    try {
      ...
      console.error(`Failed to test integration: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  async getInstalledIntegrations(organizationId: string): Promise<any[]> {
    try {
      ...
      console.error(`Failed to get installed integrations: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  async uninstallIntegration(
    ...
    try {
      ...
      console.error(`Failed to uninstall integration: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  async getIntegrationCategories(): Promise<any[]> {
    try {
      ...
      console.error(`Failed to get integration categories: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  async searchIntegrations(query: string, category?: string): Promise<AvailableIntegration[]> {
    try {
      ...
      console.error(`Failed to search integrations: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  async getIntegrationAnalytics(organizationId: string): Promise<any> {
    try {
      ...
      console.error(`Failed to get integration analytics: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
      throw error;
    }
  }
  ...
  private async logIntegrationEvent(eventData: {
    ...
    try {
      ...
      console.error(`Failed to log integration event: ${error instanceof Error ? error instanceof Error ? error.message : "Unknown error" : "Unknown error"}`, error instanceof Error ? error instanceof Error ? error.stack : undefined : undefined);
