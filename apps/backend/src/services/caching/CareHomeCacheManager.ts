/**
 * @fileoverview Care home cache manager - optimized for resident and medical data
 * @module CareHomeCacheManager
 * @version 1.0.0
 * @author WriteCareNotes Team
 * @since 2025-01-01
 * 
 * @description Provides care home-specific caching patterns, invalidation strategies,
 * and compliance-aware cache management for medical data, resident information,
 * and care-related operations with healthcare system integration support.
 * 
 * @example
 * // Care home cache usage
 * const cacheManager = new CareHomeCacheManager();
