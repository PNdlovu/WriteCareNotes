      ...
      const alerts = [
        {
          ...
          type: 'interaction',
          severity: 'critical',
          message: 'Drug interactiondetected: Warfarin and Aspirin for John Smith',
          residentId: 'res-2',
          medicationId: 'med-1',
        ...
        },
        {
          ...
          type: 'allergy',
          severity: 'high',
          message: 'Patient allergyalert: Mary Johnson is allergic to Penicillin',
          residentId: 'res-1',
          medicationId: 'med-2',
        ...
        },
        {
          ...
          type: 'expiry',
          severity: 'medium',
          message: 'Medication expiringsoon: Insulin expires in 7 days',
          medicationId: 'med-3',
