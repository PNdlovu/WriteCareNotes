...
import { BudgetManagementService } from '../../services/finance/BudgetManagementService';
import { Budget } from '../../entities/financial/Budget';
import { Decimal } from 'decimal.js';

/**
 * @fileoverview Budget Management Tests
 * @module BudgetManagementTests
 * @version 1.0.0
...
describe('Budget Management Service', () => {
  letservice: BudgetManagementService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<BudgetManagementService>(BudgetManagementService);
...
describe('Budget Management Integration Tests', () => {
  letapp: any;
  letbudgetManagementService: BudgetManagementService;
  ...
  describe('Budget Management Workflow', () => {
    it('should complete full budget management workflow', async () => {
      ...
      const budget = await budgetManagementService.createBudget(createData);
      ...
      const approvedBudget = await budgetManagementService.approveBudget(budget.id, approvalData);
      ...
      const updatedBudget = await budgetManagementService.updateActuals(budget.id, actualsData);
...
describe('Budget Management E2E Tests', () => {
  ...
  describe('Budget Management API Endpoints', () => {
